...
I build modern, scalable web applications with a focus on clean UI, performance, and real-world usability.

Currently working on a multi-tenant SaaS appointment scheduling platform, designing end-to-end features including booking systems, dashboards, and user flows for real businesses.

I enjoy turning complex problems into simple, intuitive user experiences — and I’m especially interested in product-driven development and building tools that people actually use.

Tech interests: React / Next.js, TypeScript, UI engineering, SaaS products, system design basics.
